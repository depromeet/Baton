...
object BdsToast {
    fun createToast(context: Context, message: String ): Toast {
        val view =  LayoutInflater.from(context).inflate(com.depromeet.bds.R.layout.bds_component_toast, null)
    ...
    //특정 위치 기준 16px 위에 올리기 기준값의 bottom 위치값을 pos로 받는다

    fun createToast(context: Context, message: String , pos : Int): Toast {
        val view =  LayoutInflater.from(context).inflate(com.depromeet.bds.R.layout.bds_component_toast, null)
        view.findViewById<TextView>(com.depromeet.bds.R.id.tvSample).text=message
