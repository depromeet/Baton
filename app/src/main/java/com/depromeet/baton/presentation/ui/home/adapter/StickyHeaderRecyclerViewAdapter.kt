...
class StickyHeaderRecyclerViewAdapter constructor(
    ...
    inner class Item1ViewHolder(var binding: FragmentTopBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind() {
        }
    }

    inner class Item2ViewHolder(var binding: FragmentHeaderBinding) :
        RecyclerView.ViewHolder(binding.root) {
        init {
    ...
    inner class Item3ViewHolder(var binding: FragmentBottomBinding) :
        RecyclerView.ViewHolder(binding.root) {
        init {
