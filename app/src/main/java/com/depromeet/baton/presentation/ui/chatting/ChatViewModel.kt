...
class ChatViewModel @Inject constructor(
    ...
    /** 채팅 이력 리스트에서 선택한 채팅방 */
    val chatRoom = savedStateHandle.get<ChatRoom>(ChatRoomActivity.GO_CHAT_ROOM_KEY)
    ...
    private fun getChatRoomList() {
        viewModelScope.launch {
            runCatching {
                ...
                //todo chatRepository.getChatRoom()
...
object ChatModule {
    ...
    @Provides
    @Singleton
    fun provideRealTimeDataPublisher(): RealTimeDataPublisher {
        return MemoryRealTimeDataPublisher()
    }

    @Provides
    @Singleton
    fun provideChatRepository(publisher: RealTimeDataPublisher): ChatRepository {
        return ChatRepository(publisher)
    }
}
