...
import com.depromeet.bds.databinding.BdsTemporaryTextfieldBinding

class TemporaryTextField @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = BdsTemporaryTextfieldBinding.inflate(layoutInflater, this, true)
